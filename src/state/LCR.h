...
#ifndef PATH_PLANNING_LCR_H
#define PATH_PLANNING_LCR_H
...
{
public:
    LCR(std::shared_ptr<const MapWaypoints> map_way_points, std::shared_ptr<Model> model, int lane,
